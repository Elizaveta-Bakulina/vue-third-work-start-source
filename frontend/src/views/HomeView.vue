            ...
            <div class="desk__filters">
                <div class="desk__user-filter">
                    ...
                    <ul class="user-filter">
                        <li class="user-filter__item" v-for="user in users"             
                        :key="user.id"
                        :title="user.name">
                ...
                <div class="desk__meta-filter">
                    ...
                    <ul class="meta-filter">
                        <li class="meta-filter__item" v-for="({ value, label }) in STATUSES"
                        :key="value">
                        <a
...
<script setup>
    ...
    import {STATUSES} from '../commom/constants'
    import {normalizeTask, getTagsArrayFromString} from '../commom/helpers'
