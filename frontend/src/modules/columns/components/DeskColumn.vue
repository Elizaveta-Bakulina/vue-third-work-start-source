<template>
    ...
    import AppDrop from '@/commom/components/AppDrop.vue'
    import AppIcon from '@/commom/components/AppIcon.vue'
    import TaskCard from '@/modules/tasks/components/TaskCard.vue'
    import { getTargetColumnTasks, addActive } from '@/commom/helpers'
